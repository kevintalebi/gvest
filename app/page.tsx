    ...
    <main className="bg-gold-gradient min-h-screen text-lux-gray overflow-x-hidden">
      <div className="w-3/4 mx-auto">
        ...
        {(() => {
          ...
          return (
            <section ref={heroRef} className={`w-3/4 min-h-[70vh] flex flex-col justify-center items-center text-center px-4 py-16 bg-transparent mx-auto transition-all duration-700 ease-out ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
              <div className="max-w-3xl w-full mx-auto flex flex-col items-center">
                ...
                <p className="text-xl md:text-2xl mb-6 md:mb-8 max-w-2xl mx-auto">Access a professionally managed, diversified property portfolio with transparent, blockchain-secured ownership. Start with as little as <span className="text-accent font-bold">$300 USDT</span>.</p>
          ...
          {/* REIT Overview */}
          {(() => {
            const [reitRef, reitVisible] = useScrollReveal();
            return (
              <section ref={reitRef} className={`w-3/4 px-4 py-12 flex flex-col md:flex-row items-center md:items-start md:justify-center gap-10 max-w-6xl mx-auto transition-all duration-700 ease-out ${reitVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
                <div className="flex-1 max-w-lg w-full mb-8 md:mb-0 md:mr-8">
                  ...
                  <ul className="space-y-3 text-lg text-left">
                    ...
                    <li>• Minimum investment: <span className="text-accent font-bold">$300 USDT</span></li>
                  </ul>
                </div>
          ...
          {(() => {
            ...
            return (
              <section ref={benefitsRef} className={`w-full px-2 py-8 transition-all duration-700 ease-out ${benefitsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
          ...
          {(() => {
            ...
            return (
              <section ref={howRef} className={`w-full px-2 py-8 transition-all duration-700 ease-out ${howVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
          ...
          {(() => {
            ...
            return (
              <section ref={portfolioRef} className={`w-full px-2 py-8 transition-all duration-700 ease-out ${portfolioVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
          ...
          {(() => {
            ...
            return (
              <section ref={galleryRef} className={`w-full px-2 py-8 transition-all duration-700 ease-out ${galleryVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
          ...
          {(() => {
            ...
            return (
              <section ref={trustRef} className={`w-full px-2 py-8 transition-all duration-700 ease-out ${trustVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
          ...
          {/* Real Estate Investment Program - NEW SECTION */}
          {(() => {
            const [programRef, programVisible] = useScrollReveal();
            return (
              <section ref={programRef} className={`w-full px-2 py-8 transition-all duration-700 ease-out ${programVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
                <h2 className="font-serif text-3xl text-accent mb-8 text-center">Real Estate Investment Program</h2>
                <div className="bg-glass border border-accent rounded-lux shadow-gold-glow p-8 text-center max-w-2xl mx-auto">
                  <p className="text-lg mb-6">Minimum investment is <span className="text-accent font-bold">$300</span>.<br/>Your monthly income depends on your investment amount:</p>
                  <ol className="space-y-4 text-left mx-auto max-w-md list-decimal list-inside">
                    <li className="flex items-start gap-3 bg-yellow-50/60 border-l-4 border-accent rounded-md p-4 shadow-sm">
                      <span className="text-2xl font-bold text-accent">1</span>
                      <div>
                        <span className="text-accent font-bold">$300 - $2,999</span><br/>
                        <span className="text-lg">6% monthly income</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3 bg-yellow-100/60 border-l-4 border-accent rounded-md p-4 shadow-sm">
                      <span className="text-2xl font-bold text-accent">2</span>
                      <div>
                        <span className="text-accent font-bold">$3,000 - $29,999</span><br/>
                        <span className="text-lg">7% monthly income</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3 bg-yellow-200/60 border-l-4 border-accent rounded-md p-4 shadow-sm">
                      <span className="text-2xl font-bold text-accent">3</span>
                      <div>
                        <span className="text-accent font-bold">$30,000+</span><br/>
          ...
          {(() => {
            const [referralRef, referralVisible] = useScrollReveal();
            return (
              <section ref={referralRef} className={`w-full px-2 py-8 transition-all duration-700 ease-out ${referralVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
      ...
      <footer className="w-full flex flex-col items-center justify-center py-8 mt-8 border-t border-accent bg-gold-gradient">
        ...
        <div className="flex flex-col md:flex-row items-center gap-2 mt-4 text-gray-dark text-sm">
          <span>© {new Date().getFullYear()} GoodmanVest. All rights reserved.</span>
          <span className="hidden md:inline-block mx-2">|</span>
          <Link href="/privacy-policy" className="underline hover:text-accent transition-colors">Privacy Policy</Link>
        </div>
      </footer>
    </main>
  );
